...
`public/brand/` holds three originals from the client, all with heavy transparent padding:

| File | What |
|---|---|
| `AI-ROBOTIC-QUAD.png` | 5000² stacked lockup (mark above wordmark), navy + blue |
| `AI-ROBOTIC-W.png` | horizontal lockup, **pure white** |
| `AI-ROBOTIC.png` | horizontal lockup, navy `rgb(65,79,105)` |

Trimmed derivatives generated with sharp:

- `wordmark-white.png` (1400×254) — **used in the header and footer** (site ground is dark)
- `wordmark-navy.png` (1400×254) — for any future light-background use
- `app/icon.png` (512²) — triangle mark only; the wordmark is illegible below ~64px
- `app/apple-icon.png` (180²) — full lockup flattened on white, since iOS blackens alpha
